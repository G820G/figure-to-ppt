...
Before every conversion, the skill asks whether to enable `arrow_native_mode`. The original Chinese prompt is available in the [Simplified Chinese README](README.md):
